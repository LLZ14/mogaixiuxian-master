...
class XiuxianData {
    constructor() {
        ...
        this.monster_list9 = JSON.parse(fs.readFileSync(`${this.lib_path}/怪物列表修真界.json`));
        this.monster_list15 = JSON.parse(fs.readFileSync(`${this.lib_path}/怪物列表佛界.json`));
        //加载商品列表
        ...
        this.dijichoujiang = JSON.parse(fs.readFileSync(`${this.lib_path}/低级抽奖.json`));
        ...
        //加载抽奖卷列表
        this.choujiang_list = JSON.parse(fs.readFileSync(`${this.lib_path}/抽奖卷兑换列表.json`));
        //加载丹药列表
       ...
       //加载mc附魔书列表
        ...
        //加载世界列表
        this.shijie_list = JSON.parse(fs.readFileSync(`${this.lib_path}/世界列表.json`));
        //加载洞天福地列表
        ...
        //坐骑
        this.ZuoQi = JSON.parse(fs.readFileSync(`${this.lib_path}/坐骑列表.json`));
        this.ZuoQishiwu = JSON.parse(fs.readFileSync(`${this.lib_path}/坐骑食物列表.json`));
        ...
        //修真界
        this.xiuzhenjie = JSON.parse(fs.readFileSync(`${this.lib_path}/修真界列表.json`));
        //加载卡池
